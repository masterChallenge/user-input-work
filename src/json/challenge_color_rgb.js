const challenge_data = {
  id: 1,
  name: "",
  description: "BG-color se utiliza para cambiar el color del contenido del elemento, el reto es cambiar el backgroudn de text de prueba a rojo en funcion rgb ejemplo rgb(0, 255, 0)",
  abilitie: "",
  keywords: "",
  resolved: 0,
  attempts: 0,
  challenge: {
    ...
    validatorRules: [
      ...
      {
        id: 3,
        name: "El valor de la propiedad background-color debe ser igual a 'rgb(255,0,0)'",
        rule: "(cssRules[selectorText='.divHola'].style.'background-color' = 'rgb(255,0,0)')"
      }
    ],
    editor_data: {
