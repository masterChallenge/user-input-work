const challenge_data = {
  id: 1,
  name: "",
  description: "BG-color se utiliza para cambiar el color del contenido del elemento, el reto es cambiar el backgroudn de text de prueba a rojo en hexadecimal ejemplo #00FF00",
  abilitie: "",
  keywords: "",
  resolved: 0,
  attempts: 0,
